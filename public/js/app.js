...
(0,autosize__WEBPACK_IMPORTED_MODULE_1__["default"])(document.querySelectorAll('textarea')); // Example POST method implementation:

window.postData = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
  var url,
      data,
      response,
      _args = arguments;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          data._token = csrfToken; // Default options are marked with *
